...
const DeleteButton = ({ handleClose, parentUnique }) => {
   // Component's states
   ...
   const handleDelete = async () => {
      let errorMsg = null;
      if (parentUnique === null || parentUnique === undefined) {
      ...
      if (errorMsg === null) {
         ...
         try {
            ...
            const response = await fetch(
               `/api/admin/authorized/parents/delete/${parentUnique}`,
               {
                  method: 'DELETE',
            ...
            if (responseData.success) {
               setSuccessMessage('اولیا با موفقیت حذف شد.');
